...
class LoginController: UIViewController {
    ...
    let inputsContainerView : UIView = {
        ...
        // coz we use programmatic constraints
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "bower-logo")
    ...
    lazy var loginRegisterSegmentedControl: UISegmentedControl = {
        ...
        sc.addTarget(self, action: #selector(handleLoginRegisterSC), for: .valueChanged)
        return sc
    }()
    ...
    func setupProfileImageView(){
        // x,y,w,h of Of Profile Image View
        profileImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        profileImageView.bottomAnchor.constraint(equalTo: loginRegisterSegmentedControl.topAnchor, constant: -12).isActive = true
        profileImageView.widthAnchor.constraint(equalToConstant: 150).isActive = true
        profileImageView.heightAnchor.constraint(equalToConstant: 150).isActive = true
        //profileImageView.backgroundColor = U
    }
